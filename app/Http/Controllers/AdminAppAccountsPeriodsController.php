<?php namespace App\Http\Controllers;
	...
	class AdminAppAccountsPeriodsController extends \arivelli\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Cierre","name"=>"closed_date"];
			$this->col[] = ["label"=>"Vencimiento","name"=>"estimated_date"];
			$this->col[] = ["label"=>"Periodo","name"=>"settlement_date"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Cuenta','name'=>'account_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'account,name','datatable_ajax'=>'false'];
